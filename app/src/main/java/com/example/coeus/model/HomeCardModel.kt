...
class HomeCardModel {
    fun load():List<HomeCardData>{
        return listOf(
            HomeCardData(R.drawable.ic_home_page_course_icon,"Course Page", R.id.action_homePageFragment_to_course),
            HomeCardData(R.drawable.ic_home_page_search_icon,"Search", R.id.action_homePageFragment_to_searchFragment),
            ...
            HomeCardData(R.drawable.ic_home_page_support_icon,"Support", R.id.action_homePageFragment_to_supportFragment),
